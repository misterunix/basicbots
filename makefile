...
build:
	...
	tar cvz latest/linux64-0.0.2b.tgz basicbots/docs/ basicbots/robots/ basicbots/binaries/basicbots64-linux
	tar cvz latest/darwin64-0.0.2b.tgz basicbots/docs/ basicbots/robots/ basicbots/binaries/basicbots64-darwin
	zip -q latest/windows64-0.0.2b.zip basicbots/robots/* basicbots/docs/* basicbots/binaries/basicbots64-windows.exe
	sha256sum latest/linux64-0.0.2b.tgz
	sha256sum latest/darwin64-0.0.2b.tgz
	sha256sum latest/windows64-0.0.2b.zip
	rm -rf basicbots
